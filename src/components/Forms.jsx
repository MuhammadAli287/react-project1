...
<div className="bg-gray-100/80 p-8  ">
<form class="max-w-md mx-auto bg-white rounded-lg  p-10 shadow-2xl border-1 border-gray-300 ">
  ...
  <button type="submit" class="text-white bg-brand bg-teal-800 box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base  text-sm px-4 py-2 focus:outline-none">Submit</button>
</form>
</div>
